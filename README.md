...
(sub)domain. However you can also run both server and brokers on your own machine, simply to test it out.
    ...
    php -S localhost:8083 -t examples/server/
    export SSO_SERVER=http://dev.zingfront.cn:8083 SSO_BROKER_ID=Alice SSO_BROKER_SECRET=8iwzik1bwd; php -S 0.0.0.0:8084 -t examples/broker/
    export SSO_SERVER=http://dev.zingfront.cn:8083 SSO_BROKER_ID=Greg SSO_BROKER_SECRET=7pypoox2pc; php -S 0.0.0.0:8085 -t examples/broker/
    export SSO_SERVER=http://dev.zingfront.cn:8083 SSO_BROKER_ID=Julias SSO_BROKER_SECRET=ceda63kmhp; php -S 0.0.0.0:8086 -t examples/ajax-broker/
